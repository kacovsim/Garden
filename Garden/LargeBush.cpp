 ...
 * \date    2026/05/15
 * \brief   Implementation of the LargeBush class.
 */


#include "allObjects.h"

LargeBush::LargeBush(ShaderProgram* shdrPrg)
    : StaticModel(shdrPrg, "models/bush00.obj")
{}

void LargeBush::update(float elapsedTime, const glm::mat4* parentModelMatrix) {
