 ...
 * \date    2026/05/15
 * \brief   Implementation of the Tree00 class.
 */
...
void Tree00::update(float elapsedTime, const glm::mat4* parentModelMatrix) {
...
Tree00::Tree00(ShaderProgram* shdrPrg)
	: StaticModel(shdrPrg, "models/Tree00.obj")
{
}